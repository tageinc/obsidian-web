            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- Add new fields for address1, city, state, zipCode, and country -->
                        <div class="row mb-3">
                            <label for="address_1" class="col-md-4 col-form-label text-md-end">{{ __('Address 1') }}</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="address_2" class="col-md-4 col-form-label text-md-end">{{ __('Address 2') }} (Optional)</label>
                            <div class="col-md-6">
...
<script>
    // Add an event listener to the user_type dropdown to toggle the visibility of the contractor_license_number field.
    const userTypeDropdown = document.getElementById('user_type');
    const contractorLicenseNumberField = document.getElementById('contractor_license_number');

    userTypeDropdown.addEventListener('change', function () {
        if (userTypeDropdown.value === 'contractor') {
            contractorLicenseNumberField.style.display = 'block';
            contractorLicenseNumberField.style.display = 'flex'; // Set display style to flex
        } else {
            contractorLicenseNumberField.style.display = 'none';
        }
    });
</script>
@endif
