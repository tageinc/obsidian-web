...
run automatically. This setup uses synchronous queues; separate worker and
scheduler services are needed if you later enable background jobs or schedules.
