...
class DeviceInlineEditTest extends TestCase
{
    ...
    public function test_inline_updates_preserve_history_and_reject_protected_fields(): void
    {
        ...
        $this->insertDeviceLogs(['serial_no' => 'original', 'ps1' => 42]);
        ...
        foreach (['device_logs', 'solar_tracker_remote_controls', 'geocode'] as $table) {
    ...
    public function test_modal_updates_identity_and_preserves_linked_history(): void
    {
        ...
        $this->insertDeviceLogs(['serial_no' => 'before', 'ps1' => 42]);
        ...
        $this->assertDatabaseHas('device_logs', ['serial_no' => 'before', 'data->ps1' => 42]);
