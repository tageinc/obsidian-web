...
- Review corresponding browser/API workflows when shared business behavior changes. Reuse validation and domain logic where practical and update affected callers and documentation together.
- Do not introduce `/api/external/v1`, TAGCSOFT API-key roles, or mandatory new API equivalents for presentation-only changes.
